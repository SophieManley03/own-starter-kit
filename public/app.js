...
ReactDOM.render(React.createElement(index_1.Hello, null), document.getElementById('index'));
...
Object.defineProperty(exports, "__esModule", { value: true });
const styles = __webpack_require__(27);
const React = __webpack_require__(3);
exports.Hello = () => {
    console.log('eeee');
    return React.createElement("div", { className: styles.hello }, "Hello you!");
};
...
module.exports = {"hello":"hello-OQQ1t"};
